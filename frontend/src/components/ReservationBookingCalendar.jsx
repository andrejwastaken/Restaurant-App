...
function ReservationBookingCalendar({
  ...
  const isOperatingDay = useCallback(
    (date) => {
      // This check is MISSING in your new code
  ...
  const generateTimeSlots = () => {
    ...
    lastValidStartTime.setMinutes(
      lastValidStartTime.getMinutes() - restaurantTimeSlot
    );
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <main className="max-w-6xl mt-10 mx-auto p-6 bg-white m-4">
        <div className="flex items-center mb-8">
          <button
            //Kon reservation details
            onClick={() => navigate(-1)}
