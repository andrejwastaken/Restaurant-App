  ...
  if (!reservation) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 text-center p-4">
        ...
        <button
          onClick={() => navigate(-1)}
          className="flex items-center px-4 py-2 font-bold text-white bg-amber-600 rounded-lg hover:bg-amber-700"
        >
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 space-y-6">
        ...
        <div className="space-y-4 text-gray-700 pt-4 border-t border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <span className="font-mono bg-gray-100 px-3 py-1 rounded-md text-sm font-semibold">
