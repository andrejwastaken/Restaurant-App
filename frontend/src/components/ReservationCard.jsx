...
function ReservationCard({ reservation, onClick, viewType = 'client', disabled }) {
            ...
            <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md hover:border-amber-500 cursor-pointer transition-all duration-200 ease-in-out">
                <div className="flex justify-between items-start">
                    <div className="flex-grow space-y-1">
                        <p className={`font-bold text-lg ${getStatusColorClass(reservation.status)}`}>
                        ...
                        {viewType === 'owner' && (
                            <p className="text-sm text-gray-600">
                                ...
                                {reservation.client_user.email || reservation.client_user.phone_number}
                            </p>
                        )}
